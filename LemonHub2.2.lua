...
local Library = Update:Window("Lemon Hub","2.2",Enum.KeyCode.RightControl);

Main = Library:Tab("Chính",16435279570)
Sta = Library:Tab("Chỉ số",7040410130)
Miscf = Library:Tab("Vật phẩm",9606626859)
Sho = Library:Tab("Trái Ác Quỷ",7044233235)
Shop = Library:Tab("Cửa hàng",9606625251)
Raid = Library:Tab("Tập Kích",9606629300)
TPKub = Library:Tab("Di chuyển",9606628205)
Py = Library:Tab("Người chơi",9606626034)
-------------------------------------------------------------
